...
// data initial
const dataInicial = {
    loading: false, // --> nos va a servir para deshabilitar botones cuando se este logueando alguien
    activo: false //--> esto nos va a decir si el usuario esta activo o no
}
...
export const actualizarUsuarioAccion = (nombreActualizado) => async(dispatch, getState) => {
    ...
    try {
        // actualizando usuario Firestore
...
//en el dispatch, el payload --> modifica nuestro state